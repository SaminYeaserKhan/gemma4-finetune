# 15 — Trained AI + majority vote + selection of hard questions (30%) + large AI marker, full hint

**In standard terms:** Stacked on self-consistency@3; disagreement gate at 30% escalation; GLM-4.7-Flash verifier; L2 feedback
...
| | |
|---|---|
| Right answers | **826 of 1,319 — 62.62%** |
| Compared with the trained AI answering once | +6.75 percentage points |
| Answers turned from wrong to right | 124 |
| Answers turned from right to wrong | 35 |
