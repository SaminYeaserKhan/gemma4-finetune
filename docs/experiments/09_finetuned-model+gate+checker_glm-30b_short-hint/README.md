# 09 — Trained AI + selection of hard questions (30%) + large AI marker, short hint

**In standard terms:** disagreement gate at 30% escalation; GLM-4.7-Flash verifier; L1 feedback
...
| | |
|---|---|
| Right answers | **765 of 1,319 — 58.00%** |
| Compared with the trained AI answering once | +2.12 percentage points |
| Answers turned from wrong to right | 52 |
...
flowchart TD
    ...
    KEEP2 --> RES
    R2 --> RES
    RES["<b>765 right</b> (58.0%)<br/>554 wrong"]
