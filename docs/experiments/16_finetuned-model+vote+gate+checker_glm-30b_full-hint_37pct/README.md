...
| | |
|---|---|
| Right answers | **843 of 1,319 — 63.91%** |
| Compared with the trained AI answering once | +8.04 percentage points |
| Answers turned from wrong to right | 148 |
| Answers turned from right to wrong | 42 |
...
flowchart TD
    ...
    KEEP2 --> RES
    R2 --> RES
    RES["<b>843 right</b> (63.9%)<br/>476 wrong"]
