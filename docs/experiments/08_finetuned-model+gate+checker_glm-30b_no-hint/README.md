# 08 — Trained AI + selection of hard questions (30%) + large AI marker, none hint

**In standard terms:** disagreement gate at 30% escalation; GLM-4.7-Flash verifier; L0 feedback
...
| | |
|---|---|
| Right answers | **756 of 1,319 — 57.32%** |
| Compared with the trained AI answering once | +1.44 percentage points |
| Answers turned from wrong to right | 46 |
| Answers turned from right to wrong | 27 |
...
flowchart TD
    ...
    KEEP2 --> RES
    R2 --> RES
    RES["<b>756 right</b> (57.3%)<br/>563 wrong"]
