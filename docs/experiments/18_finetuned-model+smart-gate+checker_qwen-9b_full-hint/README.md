...
| | |
|---|---|
| Right answers | **861 of 1,319 — 65.28%** |
| Compared with the trained AI answering once | +9.40 percentage points |
| Answers turned from wrong to right | 136 |
...
flowchart TD
    ...
    KEEP2 --> RES
    R2 --> RES
    RES["<b>861 right</b> (65.3%)<br/>458 wrong"]
